...
面向商业应用与研发场景的高价值 AI Agent 框架精选汇总。

**EN** | [RU](README_RU.md) | [ZH](README_ZH.md)

*最后更新：2026-02-14 18:46:49*

| 排名 | 框架 | 星标 | 开发语言 | 授权协议 | 排名变动 |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
| 14 | [babyagi](#babyagi) | 22,134 | Python | 无协议 | ↑1 |
...
| 29 | [FastCode](#fastcode) | 327 | Python | 无协议 | — |
...
**您的个人 AI 助手。跨操作系统，跨平台。坚持“龙虾式”简洁之道。 🦞**
...
**AutoGPT 致力于让 AI 触手可及，供所有人使用和构建。我们的使命是提供工具，助您专注于核心业务。**
...
- 全方位产出：根据自然语言规格说明生成 PRD、架构图、源代码和测试用例。
...
**一个自主智能体，可利用任何 LLM 供应商对任何数据进行深度研究。**
...
**开源 AI 编排框架，用于构建经过上下文工程处理、生产级可用的 LLM 应用。设计模块化流水线和智能体工作流，对检索、路由、记忆和生成进行显式控制。专为可扩展智能体、RAG、多模态应用、语义搜索和对话系统打造。**
...
**🐫 CAMEL：首个且领先的多智能体框架。探索智能体缩放法则（Scaling Law）。https://www.camel-ai.org**
...
**PraisonAI 是一个生产级多 AI 智能体框架，旨在创建 AI 智能体以自动化解决从简单任务到复杂挑战的各类问题。它提供低代码解决方案以简化多智能体 LLM 系统的构建与管理，强调简单性、定制化及有效的人机协作。**
...
**本地 Topsha 🐧：专注于本地 LLM（GPT-OSS, Qwen, GLM）的个人电脑简单任务 AI 智能体**

⭐ 94 · 🍴 20 · 👥 6 · 🛠️ Python

- 完全在个人电脑本地执行，无云端依赖
- 支持集成 GPT-OSS、通义千问（Qwen）和 GLM 等本地模型
