...
*Последнее обновление: 2026-02-14 06:02:47*
...
192,564 звезд · 33,004 форков · 597 контрибьюторов · 5,478 задач · TypeScript · MIT

    - Кросс-платформенная совместимость с любой ОС (Windows, macOS, Linux)
    - Поддержка любых аппаратных платформ и устройств
    - Локальное развертывание персонального ИИ-ассистента без облака
    - Модульная архитектура 'в стиле лобстера' для гибкого захвата и интеграции моделей
...
64,164 звезд · 8,060 форков · 148 контрибьюторов · 78 задач · Python · MIT
    ...
    - Симуляция работы AI софтверной компании
    - Ролевое распределение агентов (PM, архитектор, инженер)
    - Программирование на естественном языке с генерацией кода
...
62,134 звезд · 5,342 форков · 132 контрибьюторов · 294 задач · Python · AGPL-3.0
    ...
    - Обработка естественного языка для генерации команд
    - Локальное выполнение кода на компьютере пользователя
    - Автоматическая интерпретация и исполнение Python-скриптов
    - Интеграция с файловой системой и системными ресурсами
...
54,535 звезд · 8,216 форков · 532 контрибьюторов · 586 задач · Python · CC-BY-4.0
    ...
    - Расширяемость агентов инструментами
    - Оркестрация рабочих процессов на основе агентов
...
37,839 звезд · 5,006 форков · 390 контрибьюторов · 565 задач · Python · Apache-2.0
    ...
    - Многоагентная архитектура для создания и координации агентов
    - Онлайн-обучение в реальном времени с каждой взаимодействием
    - Адаптивные механизмы самоулучшения на основе обратной связи
    - Система памяти опыта для непрерывного накопления знаний
...
35,700 звезд · 9,454 форков · 72 контрибьюторов · 220 задач · TypeScript · GPL-3.0
    ...
    - Деплой агентов без серверной инфраструктуры
...
25,412 звезд · 2,289 форков · 197 контрибьюторов · 369 задач · Python · Apache-2.0
    ...
    - Простой и легковесный API для быстрого прототипирования
...
24,698 звезд · 4,301 форков · 272 контрибьюторов · 289 задач · Python · MIT
    ...
    - Поддержка циклов для создания устойчивых и повторяющихся процессов
    - Управление состоянием, передаваемым между узлами
    - Чекпоинтинг для сохранения и возобновления выполнения
...
24,185 звезд · 2,598 форков · 323 контрибьюторов · 112 задач · MDX · Apache-2.0
    ...
    - Поддержка масштабируемых агентов и RAG-приложений
...
22,133 звезд · 2,849 форков · 2 контрибьюторов · 17 задач · Python · No License
    ...
    - Автономное создание новых задач с использованием LLM (например, GPT-4)
    - Приоритизация задач на основе векторных эмбеддингов и поиска по сходству
    - Выполнение задач через специализированного агента на базе LLM
    - Хранение и управление историей задач в векторной базе данных (Pinecone)
...
20,950 звезд · 2,228 форков · 14 контрибьюторов · 16 задач · Python · MIT
    ...
    - Эргономичный дизайн взаимодействия агентов
    - Образовательные инструменты для изучения многоагентных систем
...
17,506 звезд · 5,413 форков · 651 контрибьюторов · 140 задач · TypeScript · MIT
    ...
    - Интеграция с различными LLM и внешними API
    - Встроенная система памяти и планирования задач
    - Простота развертывания без кода для всех пользователей
...
16,015 звезд · 1,771 форков · 192 контрибьюторов · 444 задач · Python · Apache-2.0
    ...
    - Система коммуникации и ролевого распределения агентов
...
14,869 звезд · 1,640 форков · 368 контрибьюторов · 535 задач · Python · MIT
    ...
    - Интеграция инструментов (tools) на основе схем Pydantic
    - Модульная архитектура для создания многоагентных GenAI систем
...
3,978 звезд · 460 форков · 47 контрибьюторов · 7 задач · Python · Apache-2.0
    ...
    - Обработка сложных многоэтапных задач с цепочками рассуждений
    - Модульная структура для легкой интеграции инструментов и агентов
