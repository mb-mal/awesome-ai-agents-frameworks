...
*Последнее обновление: 2026-02-14 18:41:17*
...
193,946 звезд · 33,366 форков · 607 контрибьюторов · 5,669 задач · TypeScript · MIT
...
181,798 звезд · 46,221 форков · 802 контрибьюторов · 328 задач · Python · NOASSERTION


### <a name="opencode"></a>[opencode](https://github.com/anomalyco/opencode) — The open source coding agent.

104,496 звезд · 10,152 форков · 738 контрибьюторов · 5,169 задач · TypeScript · MIT
...
64,177 звезд · 8,063 форков · 148 контрибьюторов · 80 задач · Python · MIT
...
62,143 звезд · 5,344 форков · 132 контрибьюторов · 295 задач · Python · AGPL-3.0


### <a name="autogen"></a>[autogen](https://github.com/microsoft/autogen) — A programming framework for agentic AI

54,542 звезд · 8,218 форков · 532 контрибьюторов · 587 задач · Python · CC-BY-4.0
...
44,116 звезд · 5,908 форков · 279 контрибьюторов · 281 задач · Python · MIT
...
37,841 звезд · 5,006 форков · 390 контрибьюторов · 565 задач · Python · Apache-2.0
...
35,704 звезд · 9,453 форков · 72 контрибьюторов · 220 задач · TypeScript · GPL-3.0
...
25,424 звезд · 2,291 форков · 197 контрибьюторов · 369 задач · Python · Apache-2.0
...
24,708 звезд · 4,302 форков · 272 контрибьюторов · 288 задач · Python · MIT
...
24,188 звезд · 2,599 форков · 323 контрибьюторов · 114 задач · MDX · Apache-2.0


### <a name="babyagi"></a>[babyagi](https://github.com/yoheinakajima/babyagi)

22,134 звезд · 2,849 форков · 2 контрибьюторов · 17 задач · Python · No License
...
20,952 звезд · 2,229 форков · 14 контрибьюторов · 16 задач · Python · MIT
...
18,784 звезд · 2,765 форков · 46 контрибьюторов · 411 задач · Python · MIT


### <a name="eliza"></a>[eliza](https://github.com/elizaOS/eliza) — Autonomous agents for everyone

17,506 звезд · 5,413 форков · 651 контрибьюторов · 141 задач · TypeScript · MIT
...
16,017 звезд · 1,772 форков · 192 контрибьюторов · 445 задач · Python · Apache-2.0


### <a name="pydantic-ai"></a>[pydantic-ai](https://github.com/pydantic/pydantic-ai) — GenAI Agent Framework, the Pydantic way

14,880 звезд · 1,640 форков · 368 контрибьюторов · 535 задач · Python · MIT
...
10,894 звезд · 769 форков · 44 контрибьюторов · 58 задач · MDX · Apache-2.0
...
3,953 звезд · 998 форков · 23 контрибьюторов · 14 задач · Python · MIT
...
3,098 звезд · 402 форков · 67 контрибьюторов · 4 задач · Python · Apache-2.0


### <a name="anthropic-sdk-python"></a>[anthropic-sdk-python](https://github.com/anthropics/anthropic-sdk-python)

2,760 звезд · 456 форков · 51 контрибьюторов · 102 задач · Python · MIT
...
641 звезд · 47 форков · 5 контрибьюторов · 39 задач · Rust · MIT
...
321 звезд · 38 форков · 3 контрибьюторов · 0 задач · Python · No License
...
94 звезд · 20 форков · 6 контрибьюторов · 4 задач · Python · MIT
